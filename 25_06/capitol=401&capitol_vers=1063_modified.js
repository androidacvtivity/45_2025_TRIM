...
function CAP2() {
    ...
    R7100_C1.val(formatVal(Number(R7110_C1.val())) +
        parseFloat(Number(R7120_C1.val())) +
        parseFloat(Number(R7130_C1.val())) +
        parseFloat(Number(R7140_C1.val())), 0);

    R7100_C2.val(formatVal(Number(R7110_C2.val())) +
        parseFloat(Number(R7120_C2.val())) +
        parseFloat(Number(R7130_C2.val())) +
        parseFloat(Number(R7140_C2.val())), 0);

    R7100_C3.val(formatVal(Number(R7110_C3.val())) +
        parseFloat(Number(R7120_C3.val())) +
        parseFloat(Number(R7130_C3.val())) +
        parseFloat(Number(R7140_C3.val())), 0);

    R7100_C4.val(formatVal(Number(R7110_C4.val())) +
        parseFloat(Number(R7120_C4.val())) +
        parseFloat(Number(R7130_C4.val())) +
        parseFloat(Number(R7140_C4.val())), 0);

    //-------------------------------Rind 7200-----------------------------------------------------

    R7200_C1.val(formatVal(Number(R7210_C1.val())) +
        parseFloat(Number(R7220_C1.val())) +
        parseFloat(Number(R7230_C1.val())) +
        parseFloat(Number(R7240_C1.val())) +
        parseFloat(Number(R7250_C1.val())) +
        parseFloat(Number(R7260_C1.val())), 0);

    R7200_C2.val(formatVal(Number(R7210_C2.val())) +
        parseFloat(Number(R7220_C2.val())) +
        parseFloat(Number(R7230_C2.val())) +
        parseFloat(Number(R7240_C2.val())) +
        parseFloat(Number(R7250_C2.val())) +
        parseFloat(Number(R7260_C2.val())), 0);

    R7200_C3.val(formatVal(Number(R7210_C3.val())) +
        parseFloat(Number(R7220_C3.val())) +
        parseFloat(Number(R7230_C3.val())) +
        parseFloat(Number(R7240_C3.val())) +
        parseFloat(Number(R7250_C3.val())) +
        parseFloat(Number(R7260_C3.val())), 0);

    R7200_C4.val(formatVal(Number(R7210_C4.val())) +
        parseFloat(Number(R7220_C4.val())) +
        parseFloat(Number(R7230_C4.val())) +
        parseFloat(Number(R7240_C4.val())) +
        parseFloat(Number(R7250_C4.val())) +
        parseFloat(Number(R7260_C4.val())), 0);

    //-------------------------------Rind 7300-----------------------------------------------------

    R7300_C1.val(formatVal(Number(R7310_C1.val())) +
        parseFloat(Number(R7320_C1.val())) +
        parseFloat(Number(R7330_C1.val())), 0);

    R7300_C2.val(formatVal(Number(R7310_C2.val())) +
        parseFloat(Number(R7320_C2.val())) +
        parseFloat(Number(R7330_C2.val())), 0);

    R7300_C3.val(formatVal(Number(R7310_C3.val())) +
        parseFloat(Number(R7320_C3.val())) +
        parseFloat(Number(R7330_C3.val())), 0);

    R7300_C4.val(formatVal(Number(R7310_C4.val())) +
        parseFloat(Number(R7320_C4.val())) +
        parseFloat(Number(R7330_C4.val())), 0);

    //-------------------------------Rind 7400-----------------------------------------------------

    R7400_C1.val(formatVal(Number(R7410_C1.val())) +
        ...
        parseFloat(Number(R7490_C1.val())), 0);

    R7400_C2.val(formatVal(Number(R7410_C2.val())) +
        ...
        parseFloat(Number(R7490_C2.val())), 0);

    R7400_C3.val(formatVal(Number(R7410_C3.val())) +
        ...
        parseFloat(Number(R7490_C3.val())), 0);

    R7400_C4.val(formatVal(Number(R7410_C4.val())) +
        ...
        parseFloat(Number(R7490_C4.val())), 0);

    //-------------------------------Rind 7500-----------------------------------------------------

    R7500_C1.val(formatVal(Number(R7510_C1.val())) +
        parseFloat(Number(R7520_C1.val())), 0);

    R7500_C2.val(formatVal(Number(R7510_C2.val())) +
        parseFloat(Number(R7520_C2.val())), 0);

    R7500_C3.val(formatVal(Number(R7510_C3.val())) +
        parseFloat(Number(R7520_C3.val())), 0);

    R7500_C4.val(formatVal(Number(R7510_C4.val())) +
        parseFloat(Number(R7520_C4.val())), 0);
}